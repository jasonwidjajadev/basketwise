...
SUBCATEGORY_NAME: dict[str, str] = {
    ...
    "pork": "Pork",
    "mince": "Mince",
    "sausages-burgers": "Sausages & Burgers",
    "ham": "Ham",
    "seafood": "Seafood",
    ...
    "fresh-pasta-sauces": "Fresh Pasta & Sauces",
    "ready-meals": "Ready Meals",

    # Bakery
    "bread": "Bread",
    "rolls-buns": "Rolls & Buns",
    "wraps-flatbreads": "Wraps & Flatbreads",
    "pizza-bases": "Pizza Bases",
    "cakes-sweet-treats": "Cakes & Sweet Treats",
    "breakfast-bakery": "Breakfast Bakery",
    "savoury-bakery": "Savoury Bakery",
    "bake-at-home": "Bake at Home",

    # Pantry
    "breakfast": "Breakfast",
    "coffee": "Coffee",
    "tea": "Tea",
    "jams-honey-spreads": "Jams, Honey & Spreads",
    "oils-vinegars": "Oils & Vinegars",
    "sauces": "Sauces",
    "canned-food": "Canned Food",
    "soups-noodles": "Soups & Noodles",
    "pasta-rice-grains": "Pasta, Rice & Grains",
    "baking": "Baking",
    "herbs-spices": "Herbs & Spices",
    "stocks-gravy": "Stocks & Gravy",
    ...
    "frozen-chips-wedges": "Frozen Chips & Wedges",
    "frozen-party-food": "Frozen Party Food",
    "ice-cream": "Ice Cream",
    ...
    "period-continence-care": "Period & Continence Care",
    ...
    "baby-medicinal": "Baby Medicinal",
    "dummies-teethers": "Dummies & Teethers",
    ...
    "wine": "Wine",
    "spirits": "Spirits",
    "premixed-drinks": "Premixed Drinks",
