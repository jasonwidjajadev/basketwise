  ...
  return (
    <div className="border border-bw-line bg-bw-surface">
      {groups.map((group, i) => (
        ...
        >
          <div className="flex items-baseline justify-between bg-bw-panel px-4 py-2 sm:px-5.5">
            <h3 className="text-[16px] font-medium text-bw-ink">
              {group.label}
            </h3>
            <span className="text-[10px] font-bold tracking-[.14em] text-bw-subtle uppercase">
          ...
          <div className="flex items-center justify-between border-t border-bw-line px-4 py-2 sm:px-5.5">
            <span className="text-[10.5px] font-bold tracking-[.08em] text-bw-muted uppercase">
      ...
      <div className="flex items-center justify-between bg-bw-ink-inverse-bg px-4 py-4.5 sm:px-5.5">
        <span className="text-[11px] font-bold tracking-[.16em] text-bw-on-dark uppercase">
          Total
        </span>
        <span className="text-[30px] leading-none text-white">
          {formatMoney(total)}
        </span>
      </div>
    </div>
