...
export default function EmptyCompareState() {
  return (
    <div className="flex flex-col items-center px-6 py-24 text-center lg:px-8 xl:px-12 2xl:px-16">
      <h1 className="font-newsreader text-[28px] text-bw-ink">
      ...
      <Link
        to="/browse"
        className="mt-6 rounded-full bg-bw-green px-5 py-3 font-archivo text-sm font-semibold text-white transition-colors hover:bg-bw-green-hover"
      >
        Browse products
      </Link>
    </div>
