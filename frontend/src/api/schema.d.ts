...
export interface paths {
    "/categories": {
         ...
         * @description Returns the full canonical BasketWise category tree, including categories and subcategories with zero currently mapped products.
         *
    ...
    "/products/{product_id}/price-trend": {
        ...
        /**
         * Price history merged across the local artifact and Supabase
         * @description One series per retailer, oldest first, de-duplicated to one point per day.
         *
         *     Unlike `/price-history` (which reads only the immutable artifact, and so returns a single observation) this merges in every crawl uploaded to Supabase. Returns `[]` rather than an error if Supabase is unreachable.
         */
        get: operations["price_trend_products__product_id__price_trend_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        Product: {
             ...
             */
            offers?: components["schemas"]["ProductOffer"][];
        };
        /** ProductDetail */
        ProductDetail: {
            /**
        ...
        /**
         * ProductOffer
         * @description Lightweight retailer price used on product cards.
         */
        ProductOffer: {
            /**
             * Retailer
...
export interface operations {
    ...
    list_products_products_get: {
        parameters: {
            query?: {
                ...
                tag?: string | null;
                /** @description Search over product names and brands. Size tokens (`1kg`, `500 g`, `2L`) are matched against the product size rather than its name. Multi-word queries fall back from all-terms to best-match, with plural and typo tolerance, so a query is never silently empty when something reasonable matches. */
                q?: string | null;
    ...
    price_trend_products__product_id__price_trend_get: {
        parameters: {
            query?: {
                /** @description Look back this many days. */
                days?: number;
